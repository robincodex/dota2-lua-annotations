...
---@return bool
function CDOTAGameRules:AddEventMetadataLeaderboardEntry(nameSuffix, stars, maxStars, extraData1, extraData2, extraData3, extraData4, extraData5, extraData6) return true end
...
---@param extraData6 uint
---@return bool
function CDOTAGameRules:AddEventMetadataLeaderboardEntryRawScore(nameSuffix, score, extraData1, extraData2, extraData3, extraData4, extraData5, extraData6) return true end
...
--- Env: only in `server`
---@return bool
function CDOTAGameRules:DidMatchSignoutTimeOut() return true end
...
---@return string[]
function CDOTAGameRules:GetBannedHeroes() return {} end

--- Returns the hero unit IDs banned in this game, if any.  
--- Env: `server` or `client`
---@return table
function CDOTAGameRules:GetBannedHeroIDs() return {} end

--- Returns the difficulty level of the custom game mode.  
--- Env: `server` or `client`
---@return int
function CDOTAGameRules:GetCustomGameDifficulty() return 0 end

--- Get whether a team is selectable during game setup.  
--- Env: only in `server`
---@param team DOTATeam_t
---@return int
function CDOTAGameRules:GetCustomGameTeamMaxPlayers(team) return 0 end

--- Returns difficulty level of the custom game mode.  
--- Env: `server` or `client`
---@return int
function CDOTAGameRules:GetDifficulty() return 0 end
...
---@return float
function CDOTAGameRules:GetDOTATime(includePreGame, includeNegativeTime) return 0 end
...
--- Env: `server` or `client`
---@return float
function CDOTAGameRules:GetGameFrameTime() return 0 end

--- Get the game mode entity.  
--- Env: only in `server`
---@return CDOTABaseGameMode
function CDOTAGameRules:GetGameModeEntity() return {} end
...
---@param arg2 string
---@return string
function CDOTAGameRules:GetGameSessionConfigValue(arg1, arg2) return '' end

--- Returns the number of seconds elapsed since map start. This time doesn't count up when the game is paused.  
--- Env: `server` or `client`
---@return float
function CDOTAGameRules:GetGameTime() return 0 end
...
---@param arg3 int
---@return float
function CDOTAGameRules:GetIetmStockDuration(arg1, arg2, arg3) return 0 end
...
---@return int
function CDOTAGameRules:GetItemStockCount(team, itemName, playerId) return 0 end
...
---@param playerId PlayerID
---@return float
function CDOTAGameRules:GetItemStockTime(team, itemName, playerId) return 0 end

--- Have we received the post match signout message that includes reward information.  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:GetMatchSignoutComplete() return true end

--- Gets the extra offset to initial neutral creep spawn delay.  
--- Env: `server` or `client`
---@return float
function CDOTAGameRules:GetNeutralInitialSpawnOffset() return 0 end

--- Gets next bounty rune spawn time.  
--- Env: only in `server`
---@return float
function CDOTAGameRules:GetNextBountyRuneSpawnTime() return 0 end

--- Gets next rune spawn time.  
--- Env: only in `server`
---@return float
function CDOTAGameRules:GetNextRuneSpawnTime() return 0 end

--- For New Bloom, get total damage taken by the Nian / Year Beast.  
--- Env: only in `server`
---@return int
function CDOTAGameRules:GetNianTotalDamageTaken() return 0 end
...
---@param playerId PlayerID
---@return table
function CDOTAGameRules:GetPlayerCustomGameAccountRecord(playerId) return {} end

--- Get time remaining between state changes.  
--- Env: only in `server`
---@return float
function CDOTAGameRules:GetStateTransitionTime() return 0 end

--- Get the time of day.  
--- Env: only in `server`
---@return float
function CDOTAGameRules:GetTimeOfDay() return 0 end

--- Get Weather Wind Direction Vector.  
--- Env: `server` or `client`
---@return Vector
function CDOTAGameRules:GetWeatherWindDirection() return Vector() end
...
--- Env: `server` or `client`
---@return bool
function CDOTAGameRules:IsCheatMode() return true end

--- Is it day time?  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsDaytime() return true end

---   
--- Env: `server` or `client`
---@return bool
function CDOTAGameRules:IsDev() return true end

--- Returns whether the game is paused.  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsGamePaused() return true end

--- Is the hero not blacklisted, and is it either whitelisted or the whitelist is empty?  
--- Env: `server` or `client`
---@param arg1 string
---@return bool
function CDOTAGameRules:IsHeroEnabledViaLists(arg1) return true end

--- Returns whether hero respawn is enabled.  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsHeroRespawnEnabled() return true end

--- Are we in the ban phase of hero pick?  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsInBanPhase() return true end

--- Query an item in the whitelist.  
--- Env: only in `server`
---@param itemName string
---@return bool
function CDOTAGameRules:IsItemInWhiteList(itemName) return true end

--- Is it night stalker night-time?  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsNightstalkerNight() return true end

--- Returns whether Dota Plus ability suggestions are enabled or disabled.  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsSuggestAbilitiesEnabled() return true end

--- Returns whether Dota Plus item suggestions are enabled or disabled.  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsSuggestItemsEnabled() return true end

--- Is it temporarily night-time?  
--- Env: only in `server`
---@return bool
function CDOTAGameRules:IsTemporaryNight() return true end
...
---@return int
function CDOTAGameRules:ModifyGoldFiltered(playerId, goldChange, reliable, reason) return 0 end

--- Returns the number of items currently dropped on the ground.  
--- Env: only in `server`
---@return int
function CDOTAGameRules:NumDroppedItems() return 0 end

--- Whether a player has custom game host privileges (shuffle teams, etc.).  
--- Env: only in `server`
---@param player CDOTAPlayerController
---@return bool
function CDOTAGameRules:PlayerHasCustomGameHostPrivileges(player) return true end
...
--- Env: only in `server`
---@return Uint64
function CDOTAGameRules:Script_GetMatchID() return {} end
...
---@return bool
function CDOTAGameRules:SetEventMetadataCustomTable(metadataTable) return true end

--- Event-only.  
--- Env: only in `server`
---@param metadataTable handle
---@return bool
function CDOTAGameRules:SetEventSignoutCustomTable(metadataTable) return true end
...
---@param arg1 handle
---@return bool
function CDOTAGameRules:SetPostGameColumns(arg1) return true end
...
---@param arg1 handle
---@return bool
function CDOTAGameRules:SetPostGameTeamScores(arg1) return true end
...
--- Env: `server` or `client`
---@return bool
function CDOTAGameRules:ShouldHideBlacklistedHeroes() return true end
...
function CDOTAGameRules:State_Get() return 0 end
