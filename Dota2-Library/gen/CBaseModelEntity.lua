...
---@return Vector
function CBaseModelEntity:GetAttachmentAngles(attachment) return Vector() end

--- Get the attachment id's forward vector.  
--- Env: only in `server`
---@param attachment int
---@return Vector
function CBaseModelEntity:GetAttachmentForward(attachment) return Vector() end

--- Get the attachment id's origin vector.  
--- Env: only in `server`
---@param attachment int
---@return Vector
function CBaseModelEntity:GetAttachmentOrigin(attachment) return Vector() end

--- Get the material group hash of this entity.  
--- Env: only in `server`
---@return uint
function CBaseModelEntity:GetMaterialGroupHash() return 0 end

--- Get the mesh group mask of this entity.  
--- Env: only in `server`
---@return Uint64
function CBaseModelEntity:GetMaterialGroupMask() return {} end

--- Get scale of entity's model.  
--- Env: only in `server`
---@return float
function CBaseModelEntity:GetModelScale() return 0 end

--- Get the alpha modulation of this entity.  
--- Env: `server` or `client`
---@return int
function CBaseModelEntity:GetRenderAlpha() return 0 end

--- Get the render color of the entity.  
--- Env: only in `server`
---@return Vector
function CBaseModelEntity:GetRenderColor() return Vector() end

--- Get the named attachment id.  
--- Env: only in `server`
---@param attachmentName string
---@return int
function CBaseModelEntity:ScriptLookupAttachment(attachmentName) return 0 end
