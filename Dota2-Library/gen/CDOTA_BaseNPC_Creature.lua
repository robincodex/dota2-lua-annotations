...
--- Env: only in `server`
---@return float
function CDOTA_BaseNPC_Creature:GetDisableResistance() return 0 end

--- Set creature's current disable resistance from ultimates.  
--- Env: only in `server`
---@return float
function CDOTA_BaseNPC_Creature:GetUltimateDisableResistance() return 0 end

--- Is this unit a champion?  
--- Env: only in `server`
---@return bool
function CDOTA_BaseNPC_Creature:IsChampion() return true end

--- Is this creature respawning?  
--- Env: only in `server`
---@return bool
function CDOTA_BaseNPC_Creature:IsReincarnating() return true end
