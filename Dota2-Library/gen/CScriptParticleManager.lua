...
---@return ParticleID
function CScriptParticleManager:CreateParticle(particleName, particleAttach, owner) return 0 end
...
---@return ParticleID
function CScriptParticleManager:CreateParticleForPlayer(particleName, particleAttach, owner, player) return 0 end
...
---@return ParticleID
function CScriptParticleManager:CreateParticleForTeam(particleName, particleAttach, owner, team) return 0 end
...
---@return string
function CScriptParticleManager:GetParticleReplacement(particleName, hero) return '' end
...
---@param checkFoW bool
---@return bool
function CScriptParticleManager:SetParticleShouldCheckFoW(particle, checkFoW) return true end
