...
--- Env: `server` or `client`
---@return bool
function CDOTA_Buff:DestroyOnExpire() return true end
...
--- Env: `server` or `client`
---@return float
function CDOTA_Buff:GetAuraDuration() return 0 end
...
--- Env: `server` or `client`
---@return string
function CDOTA_Buff:GetClass() return '' end

---   
--- Env: `server` or `client`
---@return float
function CDOTA_Buff:GetCreationTime() return 0 end

---   
--- Env: `server` or `client`
---@return float
function CDOTA_Buff:GetDieTime() return 0 end

---   
--- Env: `server` or `client`
---@return float
function CDOTA_Buff:GetDuration() return 0 end

---   
--- Env: `server` or `client`
---@return float
function CDOTA_Buff:GetElapsedTime() return 0 end

---   
--- Env: `server` or `client`
---@return float
function CDOTA_Buff:GetLastAppliedTime() return 0 end

---   
--- Env: `server` or `client`
---@return string
function CDOTA_Buff:GetName() return '' end

--- Get the unit the modifier is parented to.  
--- Env: `server` or `client`
---@return CDOTA_BaseNPC
function CDOTA_Buff:GetParent() return {} end

---   
--- Env: `server` or `client`
---@return float
function CDOTA_Buff:GetRemainingTime() return 0 end

---   
--- Env: `server` or `client`
---@return int
function CDOTA_Buff:GetSerialNumber() return 0 end

---   
--- Env: `server` or `client`
---@return int
function CDOTA_Buff:GetStackCount() return 0 end

---   
--- Env: `server` or `client`
---@param func modifierfunction
---@return bool
function CDOTA_Buff:HasFunction(func) return true end
...
--- Env: `server` or `client`
---@return bool
function CDOTA_Buff:IsDebuff() return true end

---   
--- Env: `server` or `client`
---@return bool
function CDOTA_Buff:IsHexDebuff() return true end

---   
--- Env: `server` or `client`
---@return bool
function CDOTA_Buff:IsStunDebuff() return true end
...
---@param offset float
---@return bool
function CDOTA_Buff:SetOverheadEffectOffset(offset) return true end
