...
--- Env: only in `server`
---@return bool
function CDOTA_Modifier_Lua_Vertical_Motion:ApplyVerticalMotionController() return true end

--- Get the priority.  
--- Env: only in `server`
---@return modifierpriority
function CDOTA_Modifier_Lua_Vertical_Motion:GetMotionPriority() return 0 end
