...
function CDOTA_Ability_Lua:CastFilterResult() return 0 end

--- Determine whether an issued command on a location is valid.  
--- Env: `server` or `client`
---@param location Vector
---@return UnitFilterResult
function CDOTA_Ability_Lua:CastFilterResultLocation(location) return 0 end

--- Determine whether an issued command on a target is valid.  
--- Env: `server` or `client`
---@param target CDOTA_BaseNPC
---@return UnitFilterResult
function CDOTA_Ability_Lua:CastFilterResultTarget(target) return 0 end

---   
--- Env: `server` or `client`
---@param level int
---@return float
function CDOTA_Ability_Lua:GetAbilityChargeRestoreTime(level) return 0 end

--- Allows code overriding of the ability texture shown in the HUD.  
--- Env: only in `client`
---@return string
function CDOTA_Ability_Lua:GetAbilityTextureName() return '' end

--- Controls the size of the AOE casting cursor.  
--- Env: `server` or `client`
---@return float
function CDOTA_Ability_Lua:GetAOERadius() return 0 end

--- Returns abilities that are stolen simultaneously, or otherwise related in functionality.  
--- Env: only in `server`
---@return string
function CDOTA_Ability_Lua:GetAssociatedPrimaryAbilities() return '' end

--- Returns other abilities that are stolen simultaneously, or otherwise related in functionality.  Generally hidden abilities.  
--- Env: only in `server`
---@return string
function CDOTA_Ability_Lua:GetAssociatedSecondaryAbilities() return '' end

--- Return cast behavior type of this ability.  
--- Env: `server` or `client`
---@return DOTA_ABILITY_BEHAVIOR
function CDOTA_Ability_Lua:GetBehavior() return 0 end

--- Return casting animation of this ability.  
--- Env: only in `server`
---@return GameActivity_t
function CDOTA_Ability_Lua:GetCastAnimation() return 0 end

--- Return cast point of this ability.  
--- Env: `server` or `client`
---@return float
function CDOTA_Ability_Lua:GetCastPoint() return 0 end
...
---@return int
function CDOTA_Ability_Lua:GetCastRange(location, target) return 0 end
...
---@return int
function CDOTA_Ability_Lua:GetCastRangeBonus(target, pseudoCastRange) return 0 end

--- Return channel animation of this ability.  
--- Env: only in `server`
---@return GameActivity_t
function CDOTA_Ability_Lua:GetChannelAnimation() return 0 end

--- Return mana cost at the given level per second while channeling (-1 is current).  
--- Env: `server` or `client`
---@param level int
---@return int
function CDOTA_Ability_Lua:GetChannelledManaCostPerSecond(level) return 0 end

--- Return the channel start time of this ability.  
--- Env: `server` or `client`
---@return float
function CDOTA_Ability_Lua:GetChannelStartTime() return 0 end

--- Return the channel time of this ability.  
--- Env: `server` or `client`
---@return float
function CDOTA_Ability_Lua:GetChannelTime() return 0 end

--- Return who hears speech when this spell is cast.  
--- Env: only in `server`
---@return int
function CDOTA_Ability_Lua:GetConceptRecipientType() return 0 end

--- Return cooldown of this ability.  
--- Env: `server` or `client`
---@param level int
---@return float
function CDOTA_Ability_Lua:GetCooldown(level) return 0 end

--- Return the error string of a failed command with no target.  
--- Env: `server` or `client`
---@return string
function CDOTA_Ability_Lua:GetCustomCastError() return '' end

--- Return the error string of a failed command on a location.  
--- Env: `server` or `client`
---@param location Vector
---@return string
function CDOTA_Ability_Lua:GetCustomCastErrorLocation(location) return '' end

--- Return the error string of a failed command on a target.  
--- Env: `server` or `client`
---@param target CDOTA_BaseNPC
---@return string
function CDOTA_Ability_Lua:GetCustomCastErrorTarget(target) return '' end

--- (DOTA_INVALID_ORDERS nReason) Return the error string of a failed order.  
--- Env: `server` or `client`
---@param reason int
---@return string
function CDOTA_Ability_Lua:GetCustomHudErrorMessage(reason) return '' end
...
---@param target handle
---@return int
function CDOTA_Ability_Lua:GetEffectiveCastRange(location, target) return 0 end

--- Return gold cost at the given level (-1 is current).  
--- Env: `server` or `client`
---@param level int
---@return int
function CDOTA_Ability_Lua:GetGoldCost(level) return 0 end

--- Returns the name of the modifier applied passively by this ability.  
--- Env: only in `server`
---@return string
function CDOTA_Ability_Lua:GetIntrinsicModifierName() return '' end

--- Return mana cost at the given level (-1 is current).  
--- Env: `server` or `client`
---@param level int
---@return int
function CDOTA_Ability_Lua:GetManaCost(level) return 0 end

--- Return the animation rate of the cast animation.  
--- Env: only in `server`
---@return float
function CDOTA_Ability_Lua:GetPlaybackRateOverride() return 0 end

--- Is this ability an Attribute Bonus.  
--- Env: `server` or `client`
---@return bool
function CDOTA_Ability_Lua:IsAttributeBonus() return true end

--- Is this a cosmetic only ability?  
--- Env: only in `server`
---@param entity handle
---@return bool
function CDOTA_Ability_Lua:IsCosmetic(entity) return true end

--- Returns true if this ability can be used when not on the action panel.  
--- Env: `server` or `client`
---@return bool
function CDOTA_Ability_Lua:IsHiddenAbilityCastable() return true end

--- Returns true if this ability is hidden when stolen by Spell Steal.  
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:IsHiddenWhenStolen() return true end

--- Returns true if this ability is refreshed by Refresher Orb.  
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:IsRefreshable() return true end

--- Returns true if this ability can be stolen by Spell Steal.  
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:IsStealable() return true end
...
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:OnAbilityPhaseStart() return true end
...
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:OtherAbilitiesAlwaysInterruptChanneling() return true end

--- Returns true if this ability will generate magic stick charges for nearby enemies.  
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:ProcsMagicStick() return true end

--- Does this ability need the caster to face the target before executing?  
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:RequiresFacing() return true end

--- Returns true if this ability should return to the default toggle state when its parent respawns.  
--- Env: only in `server`
---@return bool
function CDOTA_Ability_Lua:ResetToggleOnRespawn() return true end

--- Return the type of speech used.  
--- Env: only in `server`
---@return int
function CDOTA_Ability_Lua:SpeakTrigger() return 0 end
