...
---@return ViewerID
function AddFOWViewer(teamId, location, radius, duration, obstructedVision) return 0 end
...
---@param arg2 float
---@return float
function AngleDiff(arg1, arg2) return 0 end

--- Generate a vector given a QAngles.  
--- Env: `server` or `client`
---@param arg1 QAngle
---@return Vector
function AnglesToVector(arg1) return Vector() end
...
---@return float
function ApplyDamage(options) return 0 end
...
---@param arg2 float
---@return Quaternion
function AxisAngleToQuaternion(arg1, arg2) return {} end
...
---@param arg2 Vector
---@return Vector
function CalcClosestPointOnEntityOBB(arg1, arg2) return Vector() end
...
---@param arg2 handle
---@return float
function CalcDistanceBetweenEntityOBB(arg1, arg2) return 0 end
...
---@param arg3 Vector
---@return float
function CalcDistanceToLineSegment2D(arg1, arg2, arg3) return 0 end
...
function CreateDamageInfo(arg1, arg2, arg3, arg4, arg5, arg6) return {} end

--- Pass table - Inputs: entity, effect.  
--- Env: `server` or `client`
---@param arg1 handle
---@return bool
function CreateEffect(arg1) return true end
...
function CreateHeroForPlayer(heroName, player) return {} end
...
function CreateHTTPRequest(method, url) return {} end
...
---@param url string
---@return CScriptHTTPRequest
function CreateHTTPRequestScriptVM(method, url) return {} end
...
---@return CDOTA_BaseNPC_Hero[]
function CreateIllusions(owner, heroToCopy, modifierKeys, numIllusions, padding, scramblePosition, findClearSpace) return {} end
...
function CreateItemOnPositionForLaunch(location, item) return {} end
...
---@param item CDOTA_Item|nil
---@return CDOTA_Item_Physical
function CreateItemOnPositionSync(location, item) return {} end
...
function CreateModifierThinker(caster, ability, modifierName, paramTable, origin, teamNumber, phantomBlocker) return {} end
...
function CreateRune(location, runeType) return {} end

--- Create a scene entity to play the specified scene.  
--- Env: only in `server`
---@param arg1 string
---@return CBaseAnimatingActivity
function CreateSceneEntity(arg1) return {} end
...
---@param duration float
---@return CBaseAnimatingActivity
function CreateTempTree(location, duration) return {} end
...
---@return CBaseAnimatingActivity
function CreateTempTreeWithModel(location, duration, modelName) return {} end
...
---@param arg3 Vector
---@return CBaseTrigger
function CreateTrigger(arg1, arg2, arg3) return {} end
...
---@param radius float
---@return CBaseTrigger
function CreateTriggerRadiusApproximate(vecOrigin, radius) return {} end

--- Creates a separate random number stream.  
--- Env: `server` or `client`
---@param seed int
---@return CScriptUniformRandomStream
function CreateUniformRandomStream(seed) return {} end
...
---@param team DOTATeam_t
---@return CDOTA_BaseNPC
function CreateUnitByName(unitName, location, findClearSpace, npcOwner, entityOwner, team) return {} end
...
function CreateUnitByNameAsync(unitName, location, findClearSpace, npcOwner, entityOwner, team, callback) return 0 end
...
---@param location Vector
---@return CDOTA_BaseNPC
function CreateUnitFromTable(options, location) return {} end
...
---@param arg2 Vector
---@return Vector
function CrossVectors(arg1, arg2) return Vector() end

--- Gets the value of the given cvar, as a float.  
--- Env: `server` or `client`
---@param arg1 string
---@return float
function cvar_getf(arg1) return 0 end
...
---@param arg2 float
---@return bool
function cvar_setf(arg1, arg2) return true end
...
---@param callback fun(unit: CDOTA_BaseNPC): nil
---@return int
function DebugCreateUnit(playerOwner, unitName, team, arg4, callback) return 0 end
...
---@return int
function DoCleaveAttack(attacker, target, ability, damage, startRadius, endRadius, distance, effectName) return 0 end
...
---@param arg2 handle
---@return bool
function DoIncludeScript(arg1, arg2) return true end
...
---@return SpawnGroupHandle
function DOTA_SpawnMapAtPosition(mapName, location, deferCompletion, onReadyToSpawn, onSpawnComplete, context) return 0 end
...
---@param arg2 Vector
---@return float
function DotProduct(arg1, arg2) return 0 end
...
---@param seed string
---@return string
function DoUniqueString(seed) return '' end
...
---@param arg5 bool
---@return CDOTA_Item_Physical
function DropNeutralItemAtPositionForHero(itemName, location, unit, tier, arg5) return {} end
...
---@param arg6 Vector
---@return handle
function DropNeutralItemAtPositionForHeroWithOffset(arg1, arg2, arg3, arg4, arg5, arg6) return {} end
...
---@param name string
---@return unknown
function Dynamic_Wrap(context, name) return {} end
...
---@param arg3 float
---@return float
function ExponentialDecay(arg1, arg2, arg3) return 0 end
...
---@param arg3 int
---@return bool
function FindClearRandomPositionAroundUnit(arg1, arg2, arg3) return true end
...
---@param arg3 bool
---@return bool
function FindClearSpaceForUnit(unit, location, arg3) return true end
...
---@return CDOTA_BaseNPC[]
function FindUnitsInLine(team, startPos, endPos, cacheUnit, width, teamFilter, typeFilter, flagFilter) return {} end
...
---@return CDOTA_BaseNPC[]
function FindUnitsInRadius(team, location, cacheUnit, radius, teamFilter, typeFilter, flagFilter, order, canGrowCache) return {} end
...
---@param arg1 string
---@return table
function GetAbilityKeyValuesByName(arg1) return {} end

--- Gets the ability texture name for an ability.  
--- Env: `server` or `client`
---@param abilityName string
---@return string
function GetAbilityTextureNameForAbility(abilityName) return '' end

--- Returns the currently active spawn group handle.  
--- Env: `server` or `client`
---@return SpawnGroupHandle
function GetActiveSpawnGroupHandle() return 0 end
...
---@param arg2 Vector
---@return Vector
function GetClearSpaceForUnit(arg1, arg2) return Vector() end
...
---@return string
function GetDedicatedServerKey(version) return '' end

---   
--- Env: only in `server`
---@param version string
---@return string
function GetDedicatedServerKeyV2(version) return '' end

---   
--- Env: only in `server`
---@param version string
---@return string
function GetDedicatedServerKeyV3(version) return '' end

--- Get the enity index for a tree id specified as the entindex_target of a DOTA_UNIT_ORDER_CAST_TARGET_TREE.  
--- Env: only in `server`
---@param treeId uint
---@return EntityIndex
function GetEntityIndexForTreeId(treeId) return 0 end

--- Returns the engines current frame count.  
--- Env: `server` or `client`
---@return int
function GetFrameCount() return 0 end
...
---@return float
function GetGroundHeight(location, unitHull) return 0 end
...
---@param unitHull CDOTA_BaseNPC|nil
---@return Vector
function GetGroundPosition(location, unitHull) return Vector() end

--- Get the cost of an item by name.  
--- Env: only in `server`
---@param arg1 string
---@return int
function GetItemCost(arg1) return 0 end
...
---@param arg2 int
---@return int
function GetItemDefOwnedCount(arg1, arg2) return 0 end
...
---@param arg2 int
---@return int
function GetItemDefQuantity(arg1, arg2) return 0 end

--- Get the local player on a listen server.  
--- Env: `server` or `client`
---@return CDOTAPlayerController
function GetListenServerHost() return {} end

---   
--- Env: only in `server`
---@return table
function GetLobbyEventGameDetails() return {} end

--- Get the local player ID.  
--- Env: only in `client`
---@return PlayerID
function GetLocalPlayerID() return 0 end

--- Get the local player team.  
--- Env: only in `client`
---@param arg1 int
---@return DOTATeam_t
function GetLocalPlayerTeam(arg1) return 0 end

--- Get the name of the map.  
--- Env: `server` or `client`
---@return string
function GetMapName() return '' end
...
---@param arg2 string
---@return float
function GetMaxOutputDelay(arg1, arg2) return 0 end
...
---@param arg1 handle
---@return Vector
function GetPhysAngularVelocity(arg1) return Vector() end

--- Get Velocity for VPHYS or normal object.  
--- Env: `server` or `client`
---@param arg1 handle
---@return Vector
function GetPhysVelocity(arg1) return Vector() end
...
---@param team DOTATeam_t
---@return string
function GetPotentialNeutralItemDrop(tier, team) return '' end

--- Get the current real world date.  
--- Env: only in `server`
---@return string
function GetSystemDate() return '' end

--- Get the current real world time.  
--- Env: only in `server`
---@return string
function GetSystemTime() return '' end

--- Get system time in milliseconds.  
--- Env: only in `server`
---@return double
function GetSystemTimeMS() return 0 end
...
---@param arg7 int
---@return Vector
function GetTargetAOELocation(arg1, arg2, arg3, arg4, arg5, arg6, arg7) return Vector() end
...
---@param arg7 int
---@return Vector
function GetTargetLinearLocation(arg1, arg2, arg3, arg4, arg5, arg6, arg7) return Vector() end

---   
--- Env: only in `server`
---@param team DOTATeam_t
---@return int
function GetTeamHeroKills(team) return 0 end

---   
--- Env: only in `server`
---@param team DOTATeam_t
---@return string
function GetTeamName(team) return '' end

--- Given and entity index of a tree, get the tree id for use for use with with unit orders.  
--- Env: only in `server`
---@param entityIndex EntityIndex
---@return int
function GetTreeIdForEntityIndex(entityIndex) return 0 end

--- Get unit data by ability name.  
--- Env: `server` or `client`
---@param arg1 string
---@return table
function GetUnitKeyValuesByName(arg1) return {} end

--- Gets the world's maximum X position.  
--- Env: only in `server`
---@return float
function GetWorldMaxX() return 0 end

--- Gets the world's maximum Y position.  
--- Env: only in `server`
---@return float
function GetWorldMaxY() return 0 end

--- Gets the world's minimum X position.  
--- Env: only in `server`
---@return float
function GetWorldMinX() return 0 end

--- Gets the world's minimum Y position.  
--- Env: only in `server`
---@return float
function GetWorldMinY() return 0 end

--- Get amount of XP required to reach the next level.  
--- Env: only in `server`
---@param level int
---@return int
function GetXPNeededToReachNextLevel(level) return 0 end
...
--- Env: `server` or `client`
---@return bool
function IsDedicatedServer() return true end

--- Returns true if whatever alt is remapped to is pressed.  
--- Env: only in `client`
---@return unknown
function IsDotaAltPressed() return {} end

--- Returns true if whatever ctrl is remapped to is pressed.  
--- Env: only in `client`
---@return unknown
function IsDotaCtrlPressed() return {} end
...
---@param location Vector
---@return bool
function IsLocationVisible(team, location) return true end

--- Is this entity a mango tree? (hEntity).  
--- Env: only in `server`
---@param entity CBaseEntity
---@return bool
function IsMangoTree(entity) return true end

--- Returns true if the entity is valid and marked for deletion.  
--- Env: `server` or `client`
---@param entity CBaseEntity
---@return bool
function IsMarkedForDeletion(entity) return true end
...
---@return bool
function IsUnitInValidPosition(unit) return true end

--- Checks to see if the given hScript is a valid entity.  
--- Env: `server` or `client`
---@param entity table|nil
---@return bool
function IsValidEntity(entity) return true end
...
---@param arg3 float
---@return Vector
function LerpVectors(arg1, arg2, arg3) return Vector() end
...
function ListenToGameEvent(eventName, listener, context) return 0 end

--- Creates a table from the specified keyvalues text file.  
--- Env: `server` or `client`
---@param filePath string
---@return table
function LoadKeyValues(filePath) return {} end

--- Creates a table from the specified keyvalues string.  
--- Env: `server` or `client`
---@param kvString string
---@return table
function LoadKeyValuesFromString(kvString) return {} end

--- Get the current local time.  
--- Env: `server` or `client`
---@return LocalTime
function LocalTime() return {} end

--- Checks to see if the given hScript is a valid entity.  
--- Env: `server` or `client`
---@param arg1 string
---@return int
function MakeStringToken(arg1) return 0 end
...
--- Env: `server` or `client`
---@return float
function Plat_FloatTime() return 0 end
...
---@param time float
---@return QAngle
function QSlerp(from_angle, to_angle, time) return QAngle() end
...
---@param max float
---@return float
function RandomFloat(min, max) return 0 end
...
---@param max int
---@return int
function RandomInt(min, max) return 0 end

--- Get a random 2D vector of the given length.  
--- Env: only in `server`
---@param length float
---@return Vector
function RandomVector(length) return Vector() end
...
---@return bool
function RollPercentage(successPercentage) return true end
...
---@param unit CDOTA_BaseNPC
---@return bool
function RollPseudoRandomPercentage(chance, pseudoRandomId, unit) return true end
...
---@param arg2 QAngle
---@return QAngle
function RotateOrientation(arg1, arg2) return QAngle() end
...
---@param arg3 Vector
---@return Vector
function RotatePosition(arg1, arg2, arg3) return Vector() end
...
---@param arg3 float
---@return Quaternion
function RotateQuaternionByAxisAngle(arg1, arg2, arg3) return {} end
...
---@param arg2 QAngle
---@return QAngle
function RotationDelta(arg1, arg2) return QAngle() end
...
---@param arg2 QAngle
---@return Vector
function RotationDeltaAsAngularVelocity(arg1, arg2) return Vector() end
...
---@param arg5 float
---@return float
function Script_RemapValClamped(arg1, arg2, arg3, arg4, arg5) return 0 end
...
function SpawnDOTAShopTriggerRadiusApproximate(origin, radius) return {} end
...
---@param arg7 int
---@return handle
function SpawnEffigyOfUnitOrModel(arg1, arg2, arg3, arg4, arg5, arg6, arg7) return {} end
...
---@param data table
---@return CBaseEntity
function SpawnEntityFromTableSynchronous(baseclass, data) return {} end
...
---@param arg3 handle
---@return bool
function SpawnEntityGroupFromTable(arg1, arg2, arg3) return true end
...
---@param arg2 handle
---@return int
function SpawnEntityListFromTableAsynchronous(arg1, arg2) return 0 end

--- Synchronously spawn an entity group from a list of spawn tables.  
--- Env: `server` or `client`
---@param arg1 handle
---@return handle
function SpawnEntityListFromTableSynchronous(arg1) return {} end
...
---@return handle
function SpawnMangoTree(pos, team, duration, mangoInterval, initialMangoes) return {} end
...
---@param arg3 float
---@return Quaternion
function SplineQuaternions(arg1, arg2, arg3) return {} end
...
---@param arg3 float
---@return Vector
function SplineVectors(arg1, arg2, arg3) return Vector() end
...
---@return bool
function StopListeningToGameEvent(listenerId) return true end
...
---@return bool
function TraceCollideable(query) return true end

---   
--- Env: `server` or `client`
---@param query TraceHullInputs
---@return bool
function TraceHull(query) return true end

---   
--- Env: `server` or `client`
---@param query TraceLineInputs
---@return bool
function TraceLine(query) return true end
...
function UnitFilter(npc, teamFilter, typeFilter, flagFilter, team) return 0 end
...
---@param arg1 int
---@return handle
function UserIDToControllerHScript(arg1) return {} end
...
---@param arg1 Vector
---@return QAngle
function VectorAngles(arg1) return QAngle() end

--- Get Qangles (with no roll) for a Vector.  
--- Env: `server` or `client`
---@param arg1 Vector
---@return QAngle
function VectorToAngles(arg1) return QAngle() end
