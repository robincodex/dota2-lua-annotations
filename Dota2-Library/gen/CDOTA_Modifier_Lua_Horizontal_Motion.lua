...
--- Env: only in `server`
---@return bool
function CDOTA_Modifier_Lua_Horizontal_Motion:ApplyHorizontalMotionController() return true end

--- Get the priority.  
--- Env: only in `server`
---@return modifierpriority
function CDOTA_Modifier_Lua_Horizontal_Motion:GetPriority() return 0 end
