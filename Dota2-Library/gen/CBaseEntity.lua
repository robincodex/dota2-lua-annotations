...
---@param default float
---@return float
function CBaseEntity:Attribute_GetFloatValue(name, default) return 0 end
...
---@param default int
---@return int
function CBaseEntity:Attribute_GetIntValue(name, default) return 0 end
...
--- Env: only in `server`
---@return QAngle
function CBaseEntity:EyeAngles() return QAngle() end

--- Get vector to eye position - absolute coords.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:EyePosition() return Vector() end

---   
--- Env: only in `server`
---@return CBaseEntity
function CBaseEntity:FirstMoveChild() return {} end
...
---@return Vector
function CBaseEntity:GetAbsOrigin() return Vector() end

---   
--- Env: only in `server`
---@return float
function CBaseEntity:GetAbsScale() return 0 end

---   
--- Env: only in `server`
---@return QAngle
function CBaseEntity:GetAngles() return QAngle() end

--- Get entity pitch, yaw, roll as a vector.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetAnglesAsVector() return Vector() end

--- Get the local angular velocity - returns a vector of pitch,yaw,roll.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetAngularVelocity() return Vector() end

--- Get Base? velocity.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetBaseVelocity() return Vector() end

--- Get a vector containing max bounds, centered on object.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetBoundingMaxs() return Vector() end

--- Get a vector containing min bounds, centered on object.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetBoundingMins() return Vector() end

--- Get a table containing the 'Mins' & 'Maxs' vector bounds, centered on object.  
--- Env: only in `server`
---@return EntityBounds
function CBaseEntity:GetBounds() return {} end

--- Get vector to center of object - absolute coords.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetCenter() return Vector() end

--- Get the entities parented to this entity.  
--- Env: only in `server`
---@return CBaseEntity[]
function CBaseEntity:GetChildren() return {} end
...
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetForwardVector() return Vector() end

--- Get the health of this entity.  
--- Env: `server` or `client`
---@return int
function CBaseEntity:GetHealth() return 0 end

--- Get the left vector of the entity.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetLeftVector() return Vector() end

--- Get entity local pitch, yaw, roll as a QAngle.  
--- Env: only in `server`
---@return QAngle
function CBaseEntity:GetLocalAngles() return QAngle() end

--- Maybe local angvel.  
--- Env: only in `server`
---@return QAngle
function CBaseEntity:GetLocalAngularVelocity() return QAngle() end

--- Get entity local origin as a Vector.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetLocalOrigin() return Vector() end

---   
--- Env: only in `server`
---@return float
function CBaseEntity:GetLocalScale() return 0 end

--- Get Entity relative velocity.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetLocalVelocity() return Vector() end

--- Get the mass of an entity. (returns 0 if it doesn't have a physics object).  
--- Env: only in `server`
---@return float
function CBaseEntity:GetMass() return 0 end

--- Get the maximum health of this entity.  
--- Env: `server` or `client`
---@return int
function CBaseEntity:GetMaxHealth() return 0 end

--- Returns the name of the model.  
--- Env: only in `server`
---@return string
function CBaseEntity:GetModelName() return '' end

--- If in hierarchy, retrieves the entity's parent.  
--- Env: only in `server`
---@return CBaseEntity
function CBaseEntity:GetMoveParent() return {} end

---   
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetOrigin() return Vector() end

--- Gets this entity's owner.  
--- Env: only in `server`
---@return CBaseEntity
function CBaseEntity:GetOwner() return {} end

--- Get the owner entity, if there is one.  
--- Env: only in `server`
---@return CBaseEntity
function CBaseEntity:GetOwnerEntity() return {} end
...
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetRightVector() return Vector() end

--- If in hierarchy, walks up the hierarchy to find the root parent.  
--- Env: only in `server`
---@return CBaseEntity
function CBaseEntity:GetRootMoveParent() return {} end
...
---@return float
function CBaseEntity:GetSoundDuration(soundname, actormodel) return 0 end

--- Returns the spawn group handle of this entity.  
--- Env: only in `server`
---@return SpawnGroupHandle
function CBaseEntity:GetSpawnGroupHandle() return 0 end

--- Get the team number of this entity.  
--- Env: only in `server`
---@return DOTATeam_t
function CBaseEntity:GetTeam() return 0 end

--- Get the team number of this entity.  
--- Env: `server` or `client`
---@return DOTATeam_t
function CBaseEntity:GetTeamNumber() return 0 end

--- Get the up vector of the entity.  
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetUpVector() return Vector() end

---   
--- Env: only in `server`
---@return Vector
function CBaseEntity:GetVelocity() return Vector() end

--- See if an entity has a particular attribute.  
--- Env: only in `server`
---@param name string
---@return bool
function CBaseEntity:HasAttribute(name) return true end

--- Is this entity alive?  
--- Env: only in `server`
---@return bool
function CBaseEntity:IsAlive() return true end

--- Is this entity an CDOTA_BaseNPC?  
--- Env: `server` or `client`
---@return bool
function CBaseEntity:IsBaseNPC() return true end

--- Is this entity a Dota NPC?  
--- Env: only in `server`
---@return bool
function CBaseEntity:IsDOTANPC() return true end

---   
--- Env: `server` or `client`
---@param classOrClassName string|table
---@return bool
function CBaseEntity:IsInstance(classOrClassName) return true end

--- Is this entity an CAI_BaseNPC?  
--- Env: only in `server`
---@return bool
function CBaseEntity:IsNPC() return true end

--- Back compat: Is this entity a player pawn *or* controller?  
--- Env: only in `server`
---@return bool
function CBaseEntity:IsPlayer() return true end

--- Is this entity a player controller?  
--- Env: only in `server`
---@return bool
function CBaseEntity:IsPlayerController() return true end

--- Is this entity a player pawn?  
--- Env: only in `server`
---@return bool
function CBaseEntity:IsPlayerPawn() return true end
...
--- Env: only in `server`
---@return CBaseEntity
function CBaseEntity:NextMovePeer() return {} end
...
---@return int
function CBaseEntity:TakeDamage(damageInfo) return 0 end

--- Returns the input Vector transformed from entity to world space.  
--- Env: only in `server`
---@param point Vector
---@return Vector
function CBaseEntity:TransformPointEntityToWorld(point) return Vector() end

--- Returns the input Vector transformed from world to entity space.  
--- Env: only in `server`
---@param point Vector
---@return Vector
function CBaseEntity:TransformPointWorldToEntity(point) return Vector() end
